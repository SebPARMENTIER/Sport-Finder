...
export const RESULT_API_RNA_TOTAL_PAGE_SUCCESS = 'RESULT_API_RNA_TOTAL_PAGE_SUCCESS';
...
export const getResultsFromApiTotalPageSuccess = (data) => ({
  type: RESULT_API_RNA_TOTAL_PAGE_SUCCESS,
  data,
});
